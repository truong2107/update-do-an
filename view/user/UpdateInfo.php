...
<link rel="stylesheet" href="/web/view/user/css/UpdateInfo.css">
    <script>
const quanHuyenData = {
...
<div class="container">
    ...
    <form action="/web/inc/user/InfoInc.php" method="post" style="max-width:500px;margin:auto">
        ...
        <div class="links">
            <a href="/web/index.php?act=viewInfo" class="back">Quay lại</a>
        </div>
    </form>
</div>
<script>
